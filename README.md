...
[Knex](https://github.com/knex/knex) ⭐ 20,343 | 🐛 735 | 🌐 JavaScript | 📅 2026-06-26 is a query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.

[rqlite](https://github.com/rqlite/rqlite) ⭐ 17,683 | 🐛 79 | 🌐 Go | 📅 2026-08-10 is an easy-to-use, lightweight, distributed relational database, which uses [SQLite](https://www.sqlite.org/) as its storage engine.
...
[Citus](https://github.com/citusdata/citus) ⭐ 12,695 | 🐛 1,060 | 🌐 C | 📅 2026-08-13 is a [PostgreSQL extension](https://www.citusdata.com/blog/2017/10/25/what-it-means-to-be-a-postgresql-extension/) that transforms Postgres into a distributed database—so you can achieve high performance at any scale.
...
[Scylla](https://github.com/scylladb/scylla) ⭐ 15,708 | 🐛 3,559 | 🌐 C++ | 📅 2026-08-15 is the real-time big data database that is API-compatible with Apache Cassandra and Amazon DynamoDB.
...
[ClickHouse®](https://github.com/ClickHouse/ClickHouse) ⭐ 49,261 | 🐛 6,937 | 🌐 C++ | 📅 2026-08-15 is an open-source column-oriented database management system that allows generating analytical data reports in real-time.
