...
[rqlite](https://github.com/rqlite/rqlite) ⭐ 17,739 | 🐛 79 | 🌐 Go | 📅 2026-09-15 is an easy-to-use, lightweight, distributed relational database, which uses [SQLite](https://www.sqlite.org/) as its storage engine.

[osquery](https://github.com/osquery/osquery) ⭐ 23,572 | 🐛 649 | 🌐 C++ | 📅 2026-09-16 is a SQL powered operating system instrumentation, monitoring, and analytics framework.
...
[Citus](https://github.com/citusdata/citus) ⭐ 12,773 | 🐛 1,074 | 🌐 C | 📅 2026-09-15 is a [PostgreSQL extension](https://www.citusdata.com/blog/2017/10/25/what-it-means-to-be-a-postgresql-extension/) that transforms Postgres into a distributed database—so you can achieve high performance at any scale.
...
[Scylla](https://github.com/scylladb/scylla) ⭐ 15,761 | 🐛 3,664 | 🌐 C++ | 📅 2026-09-16 is the real-time big data database that is API-compatible with Apache Cassandra and Amazon DynamoDB.
...
[ClickHouse®](https://github.com/ClickHouse/ClickHouse) ⭐ 49,927 | 🐛 7,666 | 🌐 C++ | 📅 2026-09-16 is an open-source column-oriented database management system that allows generating analytical data reports in real-time.
