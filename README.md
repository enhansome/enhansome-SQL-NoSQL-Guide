...
[PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,676 | 🐛 403 | 🌐 Haskell | 📅 2026-09-21 is a tool that serves a fully RESTful API from any existing PostgreSQL database. It provides a cleaner, more standards-compliant, faster API than you are likely to write from scratch.
...
[Atlas](https://github.com/Netflix/atlas) ⭐ 3,565 | 🐛 9 | 🌐 Scala | 📅 2026-09-18 is an in-memory dimensional [time series database](https://en.wikipedia.org/wiki/Time_series_database).
...
[Knex](https://github.com/knex/knex) ⭐ 20,342 | 🐛 753 | 🌐 JavaScript | 📅 2026-06-26 is a query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
...
[osquery](https://github.com/osquery/osquery) ⭐ 23,583 | 🐛 611 | 🌐 C++ | 📅 2026-09-17 is a SQL powered operating system instrumentation, monitoring, and analytics framework.
...
[Scylla](https://github.com/scylladb/scylla) ⭐ 15,771 | 🐛 3,678 | 🌐 C++ | 📅 2026-09-21 is the real-time big data database that is API-compatible with Apache Cassandra and Amazon DynamoDB.
...
[ClickHouse®](https://github.com/ClickHouse/ClickHouse) ⭐ 50,005 | 🐛 7,832 | 🌐 C++ | 📅 2026-09-21 is an open-source column-oriented database management system that allows generating analytical data reports in real-time.
