...
[TimescaleDB](https://github.com/timescale/timescaledb) ⭐ 23,328 | 🐛 383 | 🌐 C | 📅 2026-08-14 is an open-source database designed to make SQL scalable for time-series data. It is engineered up from PostgreSQL and packaged as a PostgreSQL extension, providing automatic partitioning across time and space (partitioning key), as well as full SQL support.
...
[osquery](https://github.com/osquery/osquery) ⭐ 23,461 | 🐛 618 | 🌐 C++ | 📅 2026-08-13 is a SQL powered operating system instrumentation, monitoring, and analytics framework.
...
[Scylla](https://github.com/scylladb/scylla) ⭐ 15,704 | 🐛 3,554 | 🌐 C++ | 📅 2026-08-14 is the real-time big data database that is API-compatible with Apache Cassandra and Amazon DynamoDB.
...
[ClickHouse®](https://github.com/ClickHouse/ClickHouse) ⭐ 49,246 | 🐛 6,914 | 🌐 C++ | 📅 2026-08-14 is an open-source column-oriented database management system that allows generating analytical data reports in real-time.
