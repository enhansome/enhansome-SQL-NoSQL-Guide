...
[PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,653 | 🐛 404 | 🌐 Haskell | 📅 2026-09-10 is a tool that serves a fully RESTful API from any existing PostgreSQL database. It provides a cleaner, more standards-compliant, faster API than you are likely to write from scratch.
...
[rqlite](https://github.com/rqlite/rqlite) ⭐ 17,726 | 🐛 76 | 🌐 Go | 📅 2026-09-09 is an easy-to-use, lightweight, distributed relational database, which uses [SQLite](https://www.sqlite.org/) as its storage engine.

[osquery](https://github.com/osquery/osquery) ⭐ 23,560 | 🐛 642 | 🌐 C++ | 📅 2026-09-09 is a SQL powered operating system instrumentation, monitoring, and analytics framework.

[SQLModel](https://github.com/tiangolo/sqlmodel) ⭐ 18,318 | 🐛 56 | 🌐 Python | 📅 2026-09-01 is a library for interacting with SQL databases from Python code, with Python objects. It is designed to be intuitive, easy to use, highly compatible, and robust.
...
[Scylla](https://github.com/scylladb/scylla) ⭐ 15,743 | 🐛 3,660 | 🌐 C++ | 📅 2026-09-10 is the real-time big data database that is API-compatible with Apache Cassandra and Amazon DynamoDB.
...
[ClickHouse®](https://github.com/ClickHouse/ClickHouse) ⭐ 49,798 | 🐛 7,518 | 🌐 C++ | 📅 2026-09-10 is an open-source column-oriented database management system that allows generating analytical data reports in real-time.
