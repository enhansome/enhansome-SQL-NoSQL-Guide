...
[PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,659 | 🐛 403 | 🌐 Haskell | 📅 2026-09-11 is a tool that serves a fully RESTful API from any existing PostgreSQL database. It provides a cleaner, more standards-compliant, faster API than you are likely to write from scratch.
...
[osquery](https://github.com/osquery/osquery) ⭐ 23,563 | 🐛 659 | 🌐 C++ | 📅 2026-09-09 is a SQL powered operating system instrumentation, monitoring, and analytics framework.
...
[ClickHouse®](https://github.com/ClickHouse/ClickHouse) ⭐ 49,852 | 🐛 7,574 | 🌐 C++ | 📅 2026-09-12 is an open-source column-oriented database management system that allows generating analytical data reports in real-time.
