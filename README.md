...
[PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,617 | 🐛 390 | 🌐 Haskell | 📅 2026-08-21 is a tool that serves a fully RESTful API from any existing PostgreSQL database. It provides a cleaner, more standards-compliant, faster API than you are likely to write from scratch.
...
[Knex](https://github.com/knex/knex) ⭐ 20,339 | 🐛 737 | 🌐 JavaScript | 📅 2026-06-26 is a query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
...
[Citus](https://github.com/citusdata/citus) ⭐ 12,716 | 🐛 1,069 | 🌐 C | 📅 2026-08-21 is a [PostgreSQL extension](https://www.citusdata.com/blog/2017/10/25/what-it-means-to-be-a-postgresql-extension/) that transforms Postgres into a distributed database—so you can achieve high performance at any scale.
...
[Scylla](https://github.com/scylladb/scylla) ⭐ 15,719 | 🐛 3,573 | 🌐 C++ | 📅 2026-08-21 is the real-time big data database that is API-compatible with Apache Cassandra and Amazon DynamoDB.
...
[ClickHouse®](https://github.com/ClickHouse/ClickHouse) ⭐ 49,380 | 🐛 6,976 | 🌐 C++ | 📅 2026-08-21 is an open-source column-oriented database management system that allows generating analytical data reports in real-time.
